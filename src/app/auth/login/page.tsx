      ...
      <div className="min-h-screen flex flex-col items-center justify-center w-full flex-1 px-5 lg:px-20 text-center">
        <div className="bg-white rounded-2xl shadow-2xl flex w-full lg:w-2/3 lg:max-w-4xl">
          <div className="w-full lg:w-3/5 p-5">
            ...
            <div className="py-10">
              <h2 className="text-2xl lg:text-3xl font-bold text-green-500 mb-2">Sign in to</h2>
              ...
              <LoginForm/>
              <Link href="/auth/join" className="lg:hidden border-2 border-green-500 bg-green-500 text-white rounded-full px-12 py-2 inline-block font-semibold hover:bg-white hover:text-green-500">Sign Up</Link>
            </div>
          </div>
